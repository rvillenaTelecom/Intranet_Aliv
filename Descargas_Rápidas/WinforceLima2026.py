...
def descargar_reporte_winforce():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # Usamos page.evaluate() global para evitar errores de locator no encontrado.
            # Inyectamos las fechas directamente en los primeros 2 inputs readonly (flatpickr)
            page.evaluate(f"""
                () => {{
