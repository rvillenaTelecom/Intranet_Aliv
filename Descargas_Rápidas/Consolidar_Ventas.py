...
def consolidar_ventas():
    ...
    output_file = r"C:\Users\Usuario\Documents\Code Aliv\Python Automate\Descargas_Rápidas\descargas_winforce_Dept\Ventas_Aliv.xlsx"
    ...
    upload_to_sql(df_consolidado, "ventas_aliv")
